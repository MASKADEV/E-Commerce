...
const Home = () => {
  ...
  return (
    <div>
      <div className='md:mt-6 mt-1 container mx-auto'>
        {/* Analytics Cards */}
        <section className="p-4 mt-[5rem] md:p-8 dark:bg-gray-800 dark:text-gray-100 text-white">
          <div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
            <div className="flex overflow-hidden rounded-lg dark:bg-gray-900 dark:text-gray-100">
              <div className="flex items-center justify-center px-4 bg-main-color dark:text-gray-800">
              ...
              <div className="flex items-center justify-between flex-1 p-3">
                <p className="text-2xl font-semibold">{state.products}</p>
                <p>Products</p>
              </div>
            </div>
            <div className="flex overflow-hidden rounded-lg dark:bg-gray-900 dark:text-gray-100">
              ...
              <div className="flex items-center justify-between flex-1 p-3">
                <p className="text-2xl font-semibold">{state.users}</p>
                <p>Customers</p>
              </div>
            </div>
            <div className="flex overflow-hidden rounded-lg dark:bg-gray-900 dark:text-gray-100">
              ...
              <div className="flex items-center justify-between flex-1 p-3">
                <p className="text-2xl font-semibold">{state.orders}</p>
                <p>Orders</p>
              </div>
            </div>
            <div className="flex overflow-hidden rounded-lg dark:bg-gray-900 dark:text-gray-100">
        ...
        <hr className="bg-white bg-opacity-70 py-[1px] mx-[3rem]"/>
        <div>
        </div>
      </div>
    </div>
